...
export default function createBullet(ecs, scene, x, y, angle = 0, speed = 500) {
  ...
  ecs.addComponent(bulletId, 'movement', createMovement(speed)); // Use passed speed
  ...
  ecs.addComponent(bulletId, 'lifespan', new Lifespan(scene.time.now, 1000)); // 1 second lifespan

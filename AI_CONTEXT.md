AI Context for Kingslayer HoldoutI’m working on a Phaser 3 game called "kingslayer-holdout" using Vite as the bundler. It’s a top-down survivor game with an ECS (Entity-Component-System) architecture for scalability. The project is managed on GitHub, using the main branch with frequent commits for version control.
File Structure
...
These practices were applied in PlayerShootingSystem.js, RenderSystem.js, SceneManager.js, MovementSystem.js, SpawnSystem.js, LifecycleSystem.js, and XPSystem.js and should be followed for all future systems/components.
Context Format
